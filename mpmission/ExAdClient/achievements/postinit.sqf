...
/*_path = "ExAdClient\achievements\customize.sqf";
...
["STR_ExAd_VG_BLACKLISTED_VEHICLE", "This vehicle is not allowed to be stored in a virtual garage!"] call ExAd_fnc_localize;
